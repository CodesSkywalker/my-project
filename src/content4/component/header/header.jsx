	...
	return (
		<>
			<div className="w-full  bg-cover h-full object-cover">
				<h2 className="absolute text-black top-10 md:top-[5%] md:left-[25%] p-6 md:p-16 lg:text-3xl text-[20px] inline-block  backdrop-blur-[5px] rounded-[20px]  w-full md:w-1/2">
					Батурин Перша згадка про місто датується 1625 роком, а от найбільшої
					слави воно зажило за часів правління Мазепи. В першу чергу Батурин –
					гетьманська столиця, тож історичних пам’яток тут чимало.
				</h2>
				<video
					className="w-full h-full "
					src="/public/video/video4.mp4"
					autoPlay
					muted
					loop
				></video>
