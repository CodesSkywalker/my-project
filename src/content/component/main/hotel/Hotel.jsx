...
const Hotel = () => {
  return (
    <div className="flex justify-center flex-col items-center">
      <span className="text-center inline-block w-full md:w-1/3 text-xl mb-4">Якщо ви приїхали здалеку та не знаєте, де можна перепочити, ось вам наші варіанти:</span>
      <div className="w-full my-20 flex flex-col lg:flex-row justify-center">
        {StopHotel.map((e) => (
          <div className="flex w-full lg:w-1/2  order border-solid h-full flex-col my-4 px-10" key={e.id}>
            ...
            <div className="flex border-t-2 pt-6 border-solid border-black justify-between">
